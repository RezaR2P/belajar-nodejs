...
// Ketika library yang bersifat non-blocking atau asynchronous tapi menggunakan promise disarankan pakai karena lebih mudah
...
await fs.writeFile("readme.md", "Belajar NodeJs keren cuy");
